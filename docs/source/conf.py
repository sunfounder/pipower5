...
language = 'ja' # make htmlを実行する前に言語を設定してください。
...
.. |link_en_tutorials| raw:: html
    ...
    <a href="https://docs.sunfounder.com/projects/pipower5/en/latest/" target="_blank">英語オンラインチュートリアル</a>

.. |link_PiPower_5_buy| raw:: html

    <a href="https://www.sunfounder.com" target="_blank">PiPower 5 購入リンク</a>
...
.. |link_pipower_tool| raw:: html
    ...
    <a href="https://github.com/sunfounder/pipower5" target="_blank">PiPower 5 ツール</a>
